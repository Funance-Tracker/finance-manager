...
class FinanceManagerApp(tk.Tk):
    def __init__(self):
        ...
        # Introduction text (centered)
        introduction_label2 = ttk.Label(main_frame, text="Some Text", font=("Arial", 18))
        introduction_label2.pack(pady=10)
...
class LoginApp(ttk.Frame):
    ...
    def create_widgets(self, parent):
        ...
        register_button = ttk.Button(self, text="Register", command=parent.show_register)
    ...
    def login(self):
        ...
        if isinstance(login_result, dict):  # Successful login
            ...
            # Add logic to switch to home screen or another frame
...
class RegisterApp(ttk.Frame):
    ...
    def create_widgets(self, parent):
        ...
        login_button = ttk.Button(self, text="Login", command=parent.show_login)
